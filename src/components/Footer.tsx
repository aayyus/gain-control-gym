...
const Footer = () => {
  return (
    <footer className="bg-gym-secondary text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">GymFlex</h3>
            <p className="text-gray-300 mb-4">
              Your complete gym management solution. Streamline operations and enhance member experience.
            </p>
